package com.mosa.data.network.result
...
object RequestErrorHandler {
    ...
    const val HTTP_CODE_CLIENT_START = 400
    const val HTTP_CODE_CLIENT_END = 499
    const val HTTP_CODE_SERVER_START = 500
    const val HTTP_CODE_SERVER_END = 599
}